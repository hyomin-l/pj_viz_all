...
st.info(
    """
- **‘똘똘한 집 한 채’ 선호**는 가격 신호가 먼저 형성된 핵심 지역을 중심으로 수요를 재배치하며,  
  이 과정에서 **강남을 축으로 한 고가 권역이 점차 구조화**되고 있다.

- 가격 상승이 선행된 지역에서 거래가 뒤따라 반응하는 패턴은,  
  **가격이 수요의 방향을 규정하는 시장으로 전환**되고 있음을 시사한다.

- 그 결과 거래는 서울 전반에서 균등하게 증가하지 않고,  
